...
create type t_review_status as enum (
    'draft',
    'pending',
    'reject',
    'publish',
...
alter table c_opportunity_search add column "review_status" t_review_status;
alter table c_opportunity_search add column "recurrence" t_recurrence;
alter table c_opportunity_search add column "end_recurrence" timestamptz;
...
begin
  ...
  values (
    ...
    (new.interior->>'review_status')::t_review_status,
