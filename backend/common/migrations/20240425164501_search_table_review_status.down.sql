...
alter table c_opportunity_search drop column if exists "end_recurrence";
alter table c_opportunity_search drop column if exists "recurrence";
alter table c_opportunity_search drop column if exists "review_status";

drop type if exists t_review_status;
