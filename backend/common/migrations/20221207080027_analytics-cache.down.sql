...
drop index if exists c_analytics_cache_by_partner;
drop index if exists c_analytics_cache_by_opportunity;
drop index if exists c_analytics_cache_by_temporary;
drop index if exists c_analytics_cache_by_dates_and_current;
