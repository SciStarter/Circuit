...
<div id="opportunity-form">
  ...
  <!-- DANIEL: I guess you shouldn't autosave if in edit mode, right? Just when adding at first?? -->
    ...
    <div class="opp-form-wrapper">
        ...
        <div v-if="state==1">
          ...
          <b-field message="64 character maximum">
             ...
             <b-input v-model="name" has-counter maxlength="64"></b-input>
           </b-field>
           <b-field message="This is the organization hosting the event, project, or attraction. This might be your organization, a chapter, or similar.">
            ...
            <b-field message="According to your account, this is your organization. If this needs to change, you must contact Science Near me.">
              <template #label>
               Parent Organization<span class="required">*</span>
            </template>
             <b-input v-model="parent" disabled></b-input>
           </b-field>
           ...
           <label class="button-radio" :class="{'open':location=='online','unselected':location=='physical' || location=='both'}">
              ...
              <div v-if="location=='online'" class="add">
                <b-field message="Must start with http:// or https://">
                   ...
                   <b-input type="url" v-model="onlineLink"></b-input>
                 </b-field>
              </div>
            </transition>
           </label>
