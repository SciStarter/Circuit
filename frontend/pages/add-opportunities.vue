      ...
      <div class="flex-row flex-row2">
        ...
        <div>
          <div>
            ...
            <p><span class="step">Step 2:</span> Follow the steps outlined in the <a href="/SNM-wordpress-integration.pdf" download>WordPress Guide</a> to install specific plug-ins that are compatible with Science Near Me.</p>
